...
@keyframes zoom{
  ...
  .bookbutton{transition:all 0.2s ease;width:150px;height:auto;border-radius:2rem;padding:0.5rem;border:1px solid #ed1c24;color:#ed1c24;text-align:center;font-weight:bolder;
  }
